...
export const Services = () => (
  <section id="services" className="pb-16 md:pb-24">
    <div className="mx-auto max-w-6xl px-4 md:px-8">
      <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-zart-body/70">Services</p>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        {SERVICES.map((s) => (
          ...
          >
            <div className="mb-2 font-poppins text-[17px] font-bold text-zart-ink">{s.name}</div>
