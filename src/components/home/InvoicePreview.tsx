    ...
    <div>
        ...
        {EXAMPLE_INVOICES.map((i) => {
          ...
          return (
            <button
              ...
              className={`rounded-full border px-3 py-1.5 font-outfit text-[11.5px] uppercase tracking-[0.05em] transition-colors ${
                on
      ...
      >
        ...
        <div className="border-b border-zart-line px-6 pb-4 pt-6">
          <div className="flex flex-wrap items-baseline justify-between gap-3 font-outfit text-[11px] uppercase tracking-[0.16em] text-zart-green">
            <span>Zart service invoice</span>
            <strong className="font-bold text-zart-ink">{invoice.ref}</strong>
          </div>
          <h3 className="mt-3 text-xl font-bold leading-tight text-zart-ink md:text-2xl">
            {invoice.job}
          </h3>
          <dl className="mt-4 grid grid-cols-[auto_1fr] gap-x-5 gap-y-1.5 font-outfit text-xs">
        ...
        <div className="px-6 py-4">
          <div className="grid grid-cols-[1fr_80px_86px] gap-2 border-b border-zart-line pb-2.5 font-outfit text-[9.5px] uppercase tracking-[0.12em] text-zart-body/70">
          ...
          {invoice.lines.map((line) => (
            <div
              ...
              className="grid grid-cols-[1fr_80px_86px] gap-2 border-b border-zart-line/50 py-2.5 font-outfit text-xs"
            >
          ...
          <div className="flex items-baseline justify-between gap-4 pt-4 font-outfit">
        ...
        <div className="bg-zart-ink px-6 py-4 font-outfit text-[11.5px] leading-relaxed text-white/75">
