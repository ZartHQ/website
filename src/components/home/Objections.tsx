...
export const Objections = () => (
  <section className="bg-zart-ink py-16 md:py-24">
    <div className="mx-auto max-w-6xl px-4 md:px-8">
      ...
      <h2 className="mb-12 mt-3 max-w-[20ch] font-satoshi text-3xl font-black leading-tight text-white md:text-[40px]">
      ...
      <div className="grid gap-px bg-white/15 md:grid-cols-3">
        {OBJECTIONS.map((o) => (
          <div key={o.quote} className="bg-zart-ink px-6 pb-8 pt-7">
            <blockquote className="mb-5 font-satoshi text-lg font-medium leading-snug text-white">
              &ldquo;{o.quote}&rdquo;
            </blockquote>
