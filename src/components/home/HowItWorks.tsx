...
export const HowItWorks = () => (
  <section id="how" className="py-16 md:py-24">
    <div className="mx-auto max-w-6xl px-4 md:px-8">
      <p className="font-outfit text-[11px] uppercase tracking-[0.14em] text-zart-body/70">How it works</p>
      <h2 className="mb-3 mt-3 max-w-[22ch] text-3xl font-bold leading-tight text-zart-ink md:text-[40px]">
      ...
      <div className="border-t border-zart-line">
        {STEPS.map((step, i) => (
          ...
          >
            <span className="rounded border border-zart-line py-1 text-center font-outfit text-[11px] tracking-[0.1em] text-zart-green">
              {String(i + 1).padStart(2, "0")}
            </span>
            <h3 className="text-xl font-bold text-zart-ink">{step.title}</h3>
